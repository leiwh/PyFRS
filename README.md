...
You can use the code in a similar way to afterglowpy (https://github.com/geoffryan/afterglowpy). See Lightcurve.ipynb for an example. The code is lightweight. One can try VegasAfterglow (https://github.com/YihanWangAstro/VegasAfterglow) by Yihan Wang a more comprehensive one. 
